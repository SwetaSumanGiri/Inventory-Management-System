...
<body>
    <div class="hi">COMPUTER PERIPHERALS</div>
    <?php
$sql = "SELECT * from products where category='Computer Peripherals'";
...
?><br>
    <div class="back">
        <button type="button"><span></span><a href="categories.html">BACK</a></button>
    </div>
<br>
